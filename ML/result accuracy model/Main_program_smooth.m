...
data_set = importdata('modified_Weather_data_set.txt')

repeat=1000;
Normal_test= zeros(repeat,1);
smooth_test= zeros(repeat,1);
for r= 1:repeat
...
Normal_test(r)= normal_model_accuracy;
smooth_test(r)= smooth_model_accuracy;
end
mean_normal_test= mean(Normal_test)
mean_smooth_test= mean(smooth_test)
